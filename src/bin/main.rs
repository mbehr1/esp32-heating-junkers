...
struct WeatherData {
    /// outside temperature
    temperature: f64,
    condition: heapless::String<50>,
    daytime: heapless::String<50>,
}
...
impl defmt::Format for HeatingThermostat {
    fn format(&self, fmt: defmt::Formatter) {
        /*let time = Timestamp::from_second(self.last_status_update)
...
static HMIPHOME: Mutex<CriticalSectionRawMutex, RefCell<Option<HMIPHome>>> =
    Mutex::new(RefCell::new(None));

static TIMESTAMP_LAST_HMIP_UPDATE: Mutex<
